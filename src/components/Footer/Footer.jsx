      ...
      <footer>
        <nav role="navigation">
          <button className="tagbutton">
            <a href="https://medium.com/tag/javascript">Javascript</a>
          </button>
          <button className="tagbutton">
            <a href="https://medium.com/tag/javascript">Optimization</a>
          </button>
          <button className="tagbutton">
            <a href="https://medium.com/tag/javascript">Performance</a>
          </button>
          <button className="tagbutton">
            <a href="https://medium.com/tag/javascript">Javascript Tips</a>
          </button>
          <button className="tagbutton">
            <a href="https://medium.com/tag/javascript">React</a>
          </button>
        </nav>
        <br></br>
        <br></br>

        <nav role="navigation" aria-label="Footer Social Icons">
          <div className="icons">
